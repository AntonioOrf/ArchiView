                    ...
                    <div class="modal-window max-w-2xl bg-white dark:bg-stone-900 overflow-hidden flex flex-col h-[80vh]">
                        <div class="modal-header shrink-0 border-b border-stone-200 dark:border-stone-800">
                            <h3 class="modal-title">
                                ...
                                <span>Novità della Versione 2.4.1</span>
                            </h3>
                        ...
                        <div class="modal-body overflow-y-auto p-6 space-y-6 text-stone-800 dark:text-stone-300">
                            ...
                            <div>
                                <h4 class="font-semibold text-lg border-b border-stone-200 dark:border-stone-700 pb-2 mb-3">Correzioni della 2.4.1</h4>
                                <ul class="list-disc pl-5 space-y-2 text-sm">
                                    <li><strong class="text-stone-900 dark:text-stone-100">Creazione dell'archivio al primo avvio:</strong> premendo "Crea Nuova Cartella Locale" subito dopo l'installazione, l'operazione poteva non produrre nulla senza alcun messaggio. Le traduzioni ora sono pronte prima che l'interfaccia risponda.</li>
                                    <li><strong class="text-stone-900 dark:text-stone-100">Albero senza riga radice:</strong> l'albero elenca solo le cartelle. Un click nell'area vuota sotto l'elenco torna alla radice, e quell'area accetta anche il trascinamento di schede e cartelle; il tasto destro nel vuoto crea la prima scheda o la prima cartella.</li>
                                    <li>Aggiornati Electron 39.8.10 e DOMPurify 3.4.13, la protezione applicata ai contenuti sincronizzati dal cloud.</li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul class="list-disc pl-5 space-y-2 text-sm">
                                    <li><strong class="text-stone-900 dark:text-stone-100">Nessun archivio "Generale" imposto:</strong> un nuovo Vault nasce vuoto. Le schede non ancora archiviate restano nella radice, e ogni cartella — compresa l'ultima rimasta — si può rinominare, spostare ed eliminare.</li>
