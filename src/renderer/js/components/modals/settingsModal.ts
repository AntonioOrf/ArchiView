        ...
        <div class="modal-window max-w-3xl h-[600px] max-h-[90vh] flex flex-col p-0 overflow-hidden">
            ...
            <div class="flex-1 overflow-hidden flex flex-col md:flex-row bg-white">
                ...
                <div class="w-full md:w-1/3 border-b md:border-b-0 md:border-r border-stone-200 dark:border-stone-700 bg-stone-50 dark:bg-stone-900/50 p-4 overflow-y-auto shrink-0">
                    <ul class="space-y-1">
                        <li><button class="settings-tab-btn w-full text-left px-3 py-2 rounded-sm font-medium bg-stone-200 text-stone-900 dark:bg-stone-700 dark:text-stone-100 transition-colors" data-target="tab-general" onclick="cambiaTabImpostazioni('tab-general')"><i data-lucide="sliders" class="w-4 h-4 inline-block mr-2 text-stone-500"></i> Generali</button></li>
                        <li><button class="settings-tab-btn w-full text-left px-3 py-2 rounded-sm font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-200 dark:hover:bg-stone-700 transition-colors" data-target="tab-data" onclick="cambiaTabImpostazioni('tab-data')"><i data-lucide="database" class="w-4 h-4 inline-block mr-2 text-stone-500"></i> Archivio Dati</button></li>
                        <li><button class="settings-tab-btn w-full text-left px-3 py-2 rounded-sm font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-200 dark:hover:bg-stone-700 transition-colors" data-target="tab-sync" onclick="cambiaTabImpostazioni('tab-sync')"><i data-lucide="cloud" class="w-4 h-4 inline-block mr-2 text-stone-500"></i> Sincronizzazione</button></li>
                        <li><button class="settings-tab-btn w-full text-left px-3 py-2 rounded-sm font-medium text-stone-600 dark:text-stone-400 hover:bg-stone-200 dark:hover:bg-stone-700 transition-colors" data-target="tab-system" onclick="cambiaTabImpostazioni('tab-system')"><i data-lucide="info" class="w-4 h-4 inline-block mr-2 text-stone-500"></i> Sistema & Info</button></li>
                    </ul>
                </div>
                        ...
                        <div id="settings-drive-section" class="hidden space-y-4">
                            ...
                            <div class="space-y-2 p-2.5 bg-stone-100 border border-stone-200 rounded-sm text-sm text-stone-700">
                                ...
                                <div class="flex gap-2 mt-2">
                                    <button id="btn-drive-login" class="btn btn-primary" onclick="loginGoogleDrive()">Accedi a Drive</button>
                                    <button id="btn-drive-logout" class="btn btn-danger hidden" onclick="logoutGoogleDrive()">Disconnetti</button>
                                    <button id="btn-drive-sync" class="btn btn-secondary hidden" onclick="sincronizzaGoogleDrive()">Sincronizza Ora</button>
                                </div>
                            </div>

                            <div class="p-3 bg-blue-50 border border-blue-200 rounded-sm text-sm text-blue-800">
                                <i data-lucide="info" class="w-4 h-4 inline-block mr-1"></i> Per gestire la sincronizzazione, gli inviti o disconnetterti, utilizza il menu <b>Cloud</b> nella barra superiore dell'applicazione.
                            </div>
                        </div>
